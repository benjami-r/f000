// My rem:
//Т.к. подключаем в asm-файл, то отключаем все typedef (string 70...).
//и отключаем (пока что?) все include (string 120...).

/**
  ******************************************************************************
  * @file    My_stm32f072xb.h
...
#ifndef __My_STM32F072xB_H
#define __My_STM32F072xB_H
